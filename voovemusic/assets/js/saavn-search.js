      ...
      results.push(`
        ...
        <div class="row" style="margin: auto;">
            ...
            <div class="col" style="border-style: none;padding: 2px;">
                ...
                <button class="btn btn-primary song-btn" type="button" style="margin: 0px 2px; background-color: mediumpurple;" onclick='PlayAudio("${download_url}","${song_id}")'>▶</button>
                <button class="btn btn-primary song-btn" type="button" style="margin: 0px 2px; background-color: mediumpurple;" onclick='AddDownload("${song_id}")'>▼</button>
